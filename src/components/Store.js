...
export default class Store extends Component {
  render() {
    return (
      <div>
        <Image src="assets/Store-header.jpg" className="header-image" />
        <Grid>
          <Col xs={12} sm={8} smOffset={2}>
            <Image src="assets/Store-Inset.jpg" className="about-profile-pic" rounded />
            ...
            <p>You better get your coat out, this is going to be a cold painting. That's the way I look when I get home late; black and blue. That's crazy. We are trying to teach you a technique here and how to use it.</p>
          </Col>
        </Grid>
      </div>
    )
